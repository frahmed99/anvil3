    ...
    <div class="row g-xxl-5 items-push py-4">
        ...
        <div class="col-xl-8">
            <div class="mb-5">
                <div class="overflow-hidden rounded mb-3" style="height: 200px;">
                    <a class="img-link" href="be_pages_generic_story.html">
                        <img class="img-fluid" src="media/photos/photo3@2x.jpg" alt="">
                    </a>
                </div>
                ...
                <p class="fs-sm mb-2">
                    ...
                    purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.
                </p>
                <a class="fs-sm link-fx fw-semibold" href="be_pages_generic_story.html">Read More..</a>
            </div>
            <div class="mb-5">
                <div class="overflow-hidden rounded mb-3" style="height: 200px;">
                    <a class="img-link" href="be_pages_generic_story.html">
                        <img class="img-fluid" src="media/photos/photo7@2x.jpg" alt="">
                    </a>
                </div>
            ...
            <div class="mb-5">
                <div class="overflow-hidden rounded mb-3" style="height: 200px;">
                    <a class="img-link" href="be_pages_generic_story.html">
                        <img class="img-fluid" src="media/photos/photo28@2x.jpg" alt="">
                    </a>
                </div>
            ...
            <div class="mb-5">
                <div class="overflow-hidden rounded mb-3" style="height: 200px;">
                    <a class="img-link" href="be_pages_generic_story.html">
                        <img class="img-fluid" src="media/photos/photo30@2x.jpg" alt="">
                    </a>
                </div>
        ...
        <div class="col-xl-4">
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content block-content-full space-y-3">
                    <div class="d-flex">
                        <img class="img-avatar img-avatar32 flex-shrink-0 me-3"
                            src="media/avatars/avatar13.jpg" alt="">
                        <div class="flex-grow-1">
                            <p class="fs-sm fw-medium mb-1">
                                In gravida nulla. Nulla vel metus scelerisque ante sollicitudin. <a
                                    class="text-elegance" href="javascript:void(0)">#startup</a> <a
                                    class="text-elegance" href="javascript:void(0)">#life</a>
                            </p>
                    ...
                    <div class="d-flex">
                        <img class="img-avatar img-avatar32 flex-shrink-0 me-3"
                            src="media/avatars/avatar5.jpg" alt="">
                        <div class="flex-grow-1">
                            <p class="fs-sm fw-medium mb-1">
                                Vestibulum in vulputate at, tempus viverra turpis. Fusce <a
                                    href="javascript:void(0)">condimentum</a> nunc ac nisi vulputate
                                fringilla.
                            </p>
                    ...
                    <div class="d-flex">
                        <img class="img-avatar img-avatar32 flex-shrink-0 me-3"
                            src="media/avatars/avatar6.jpg" alt="">
                        <div class="flex-grow-1">
                            <p class="fs-sm fw-medium mb-1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            <p class="fs-sm fw-medium mb-1">
                                Vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum <a
                                    href="javascript:void(0)">nunc</a> ac nisi vulputate fringilla. <a
                                    class="text-elegance" href="javascript:void(0)">#web</a> <a
                                    class="text-elegance" href="javascript:void(0)">#stuff</a>
                            </p>
                    ...
                    <div class="d-flex">
                        <img class="img-avatar img-avatar32 flex-shrink-0 me-3"
                            src="media/avatars/avatar8.jpg" alt="">
                        <div class="flex-grow-1">
                            <p class="fs-sm fw-medium mb-1">
                                Vestibulum in vulputate at, tempus viverra turpis. Fusce <a
                                    href="javascript:void(0)">condimentum</a> nunc ac nisi vulputate
                ...
                <div class="block-content p-3">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center justify-content-between"
                                href="javascript:void(0)">
                                <span><i class="fa fa-fw fa-magic opacity-50 me-1"></i> Special
                                    Offers</span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center justify-content-between"
                                href="javascript:void(0)">
                                <span><i class="fa fa-fw fa-pencil-alt opacity-50 me-1"></i>
                                    Tutorials</span>
    ...
    <div class="content content-full text-center">
        <div class="py-4">
            ...
            <div class="js-slider slick-nav-black" data-autoplay="true" data-autoplay-speed="6000">
                <div>
                    <div class="h3 fw-bold mb-2">&ldquo; Strive not to be a success, but rather to be of
                        value &rdquo;</div>
                    <div class="h4 fw-normal text-muted">Albert Einstein</div>
                </div>
                <div>
                    <div class="h3 fw-bold mb-2">&ldquo; Success is where preparation and opportunity meet
                        &rdquo;</div>
                    <div class="h4 fw-normal text-muted">Bobby Unser</div>
                </div>
                <div>
                    <div class="h3 fw-bold mb-2">&ldquo; Life is really simple, but we insist on making it
                        complicated &rdquo;</div>
