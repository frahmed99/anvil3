                        ...
                        <div class="row g-5 py-2">
                            <div class="col-md-4 py-2">
                                <a class="options-container push text-white rounded overflow-hidden"
                                    ...
                                    <img class="img-fluid options-item"
                                        src="/media/various/preview-page-pack-crypto.png" alt="Page Pack Crypto">
                                    <div class="options-overlay bg-black-50">
                                        <div class="options-overlay-content h5 fw-bold text-uppercase">
                                            <i class="fa fa-link fa-2x"></i>
                                        </div>
                            ...
                            <div class="col-md-4 py-2">
                                <a class="options-container push text-white rounded overflow-hidden"
                                    ...
                                    <img class="img-fluid options-item"
                                        src="/media/various/preview-page-pack-ecommerce.png"
                            ...
                            <div class="col-md-4 py-2">
                                <a class="options-container push text-white rounded overflow-hidden"
                                    ...
                                    <img class="img-fluid options-item"
                                        src="/media/various/preview-page-pack-elearning.png"
                            ...
                            <div class="col-md-4 py-2">
                                <a class="options-container push text-white rounded overflow-hidden"
                                    ...
                                    <img class="img-fluid options-item"
                                        src="/media/various/preview-page-pack-forum.png" alt="Page Pack Forum">
                                    <div class="options-overlay bg-black-50">
                                        <div class="options-overlay-content h5 fw-bold text-uppercase">
                                            <i class="fa fa-link fa-2x"></i>
                                        </div>
                            ...
                            <div class="col-md-4 py-2">
                                <a class="options-container push text-white rounded overflow-hidden"
                                    ...
                                    <img class="img-fluid options-item"
                                        src="/media/various/preview-page-pack-auth.png"
                            ...
                            <div class="col-md-4 py-3">
                                <a class="options-container push text-white rounded overflow-hidden"
                                    ...
                                    <img class="img-fluid options-item"
                                        src="/media/various/preview-page-pack-error.png" alt="Page Pack Error">
                                    <div class="options-overlay bg-black-50">
                                        <div class="options-overlay-content h5 fw-bold text-uppercase">
                                            <i class="fa fa-link fa-2x"></i>
                                        </div>
                ...
                <div class="row g-0 pull-b text-center overflow-hidden">
                    <div class="col-4">
                        <a class="options-container" href="be_pages_dashboard.html" target="_blank">
                            <img class="img-fluid options-item"
                                src="/media/various/landing-promo-layout-backend.png" alt="Backend Promo">
                    ...
                    <div class="col-4">
                        <a class="options-container" href="db_classic.html" target="_blank">
                            <img class="img-fluid options-item"
                                src="/media/various/landing-promo-layout-classic-dashboard.png"
                ...
                <div class="row g-0 pull-b text-center overflow-hidden">
                    <div class="col-4">
                        <a class="options-container" href="be_ui_grid.html" target="_blank">
                            <img class="img-fluid options-item"
                                src="/media/various/landing-promo-bootstrap-grid.png" alt="Bootstrap 5 Grid Promo">
                    ...
                    <div class="col-4">
                        <a class="options-container" href="be_ui_typography.html" target="_blank">
                            <img class="img-fluid options-item"
                                src="/media/various/landing-promo-bootstrap-typography.png"
                    ...
                    <div class="col-4">
                        <a class="options-container" href="be_ui_buttons.html" target="_blank">
                            <img class="img-fluid options-item"
                                src="/media/various/landing-promo-bootstrap-buttons.png"
        ...
        <div class="bg-body-extra-light">
            <div class="content content-full">
                ...
                <div class="row g-0 justify-content-center pull-b text-center overflow-hidden">
                    <div class="col-sm-6">
                        <img class="img-fluid" src="/media/various/landing-promo-smart-tools.png"
