                                ...
                                <div class="col-lg-7 offset-lg-1">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="company" name="company"
                                            placeholder=" " value="{{ $customer->company }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="contact" name="contact"
                                            placeholder=" " value="{{ $customer->contact }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="taxId" name="taxId"
                                            placeholder=" " value="{{ $customer->taxId }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <textarea class="form-control" id="billingAddress" name="billingAddress" style="height: 200px" placeholder=" ">{{ $customer->billingAddress }}</textarea>
                                    ...
                                    <div class="form-floating mb-4">
                                        <textarea class="form-control" id="shippingAddress" name="shippingAddress" style="height: 200px" placeholder=" " ">{{ $customer->shippingAddress }}</textarea>
