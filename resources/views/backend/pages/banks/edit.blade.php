                                ...
                                <div class="col-lg-7 offset-lg-1">
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="accountName" name="accountName"
                                            placeholder=" " value="{{ $bank->accountName }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="bankName" name="bankName"
                                            placeholder=" " value="{{ $bank->bankName }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="accountNumber" name="accountNumber"
                                            placeholder=" " value="{{ $bank->accountNumber }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" class="form-control" id="contact" name="contact"
                                            placeholder=" " value="{{ $bank->contact }}">
                                    ...
                                    <div class="form-floating mb-4">
                                        <textarea class="form-control" id="address" name="address" style="height: 200px" placeholder=" ">{{ $bank->address }}</textarea>
