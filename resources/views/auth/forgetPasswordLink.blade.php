                        ...
                        <div class="content content-full">
                            ...
                            <form action="{{ route('reset.password.post') }}" method="POST">
                                ...
                                <div class="form-floating mb-4">
                                    ...
                                    @endif
                                    <label class="form-label" for="reminder-credential">{{ __('Email') }}</label>
                                </div>
                                ...
                                <div class="form-floating mb-4">
                                    ...
                                    @endif
                                    <label class="form-label" for="reminder-credential">{{ __('Password') }}</label>
                                </div>
                                <div class="form-floating mb-4">
                                    ...
                                    @endif
                                <label class="form-label" for="reminder-credential">{{ __('Confirm Password') }}</label>
                                </div>
                                <div class="mb-4">
